...
skill_config.RelationshipType = {
	...
	SQUAD_SKILL_EXCLUSIONS = "squadSkillExclusions",
	SQUAD_SKILL_INCLUSIONS = "squadSkillInclusions",
...
local relationshipConfigKeys = {
	...
	[skill_config.RelationshipType.SQUAD_SKILL_EXCLUSIONS] = {
		added = "addedSquadSkillExclusions",
		removed = "removedSquadSkillExclusions",
		sortOrder = "squadSkillExclusionsSortOrder",
		title = "Exclusions: Squad → Skill",
		tooltip = "Prevent all pilots in specific squads from receiving certain skills",
		sourceLabel = "Squad",
		targetLabel = "Skill",
		isBidirectional = false,
	},
	[skill_config.RelationshipType.SQUAD_SKILL_INCLUSIONS] = {
		added = "addedSquadSkillInclusions",
		removed = "removedSquadSkillInclusions",
		sortOrder = "squadSkillInclusionsSortOrder",
		title = "Inclusions: Squad → Skill",
		tooltip = "Allow all pilots in specific squads to receive the skill",
		sourceLabel = "Squad",
		targetLabel = "Skill",
		isBidirectional = false,
	},
